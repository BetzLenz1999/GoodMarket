...
Env knobs (all optional unless noted):
    ...
    TELEGRAM_DAILY_REWARD_UTC_HOUR           – fire hour, 0-23 (default 2 = 10:30 AM PHT)
    TELEGRAM_DAILY_REWARD_UTC_MINUTE         – fire minute (default 30)
...
_UTC_MINUTE = get_env_int("TELEGRAM_DAILY_REWARD_UTC_MINUTE", 30)
